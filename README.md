...
Note: you can add the option ````-v```` to any of the commands to compare the output of the formulas against the Lattice Estimator (see Dependencies).
...
Please report bugs through the [GitHub issue tracker](https://github.com/Crypto-TII/fastparameterselection/issues)
