...
def helper():
    ...
    print('\n  # Example 2: Estimate logq with ternary secret')
    print('  python3 src/estimate.py --param "lambda" --n "1024" --logq "20;24-28;30;33;37;42" --secret "binary" --error "gaussian" --std "3.19"')
    print('\n  # Example 3: Estimate std_e')
    print('  python3 src/estimate.py --param "std_e" --lambda "100" --n "1024" --logq "32" --secret "binary" --table -v')
    print('\n  # Example 4: Check NTRU parameters')
    print('  python3 src/estimate.py --param "lambda" --n "1024" --logq "40" --hw "64" --secret "sparse" --ntru')
    print('\n  # Example 5: Output results in table format with verification using the Lattice Estimator')
