...
python3 src/estimate.py --param "n" --lambda "80" --logq "20-30" --secret "binary" --error "gaussian" --std "3.19"
python3 src/estimate.py --param "logq" --lambda "80" --n "1024" --secret "binary" --error "gaussian" --std "3.19"
...
python3 src/estimate.py --param "lambda" --n "1024" --logq "20" --secret "binary" --error "gaussian" --std "3.19" -v --table
python3 src/estimate.py --param "n" --lambda "80" --logq "20" --secret "binary" --error "gaussian" --std "3.19" -v --table
python3 src/estimate.py --param "logq" --lambda "80" --n "1024" --secret "binary" --error "gaussian" --std "3.19" -v --table
